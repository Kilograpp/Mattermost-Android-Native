...
public class ClientCfg extends RealmObject {
         ...
         *
         * @return
         * The enableOAuthServiceProvider
         */
         ...
         *
         * @return
         * The enableOnlyAdminIntegrations
         */
         ...
         *
         * @return
         * The enablePostUsernameOverride
         */
